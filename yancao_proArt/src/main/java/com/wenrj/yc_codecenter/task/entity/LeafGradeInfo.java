...
public class LeafGradeInfo {
    private String grade_code;
    private String grade_name;
    private String leaf_grade;
    private String big_grade_code;
    ...
    private String production_flag;
    private String move_flag;
    private String parch_flag;
    ...
    public String getLeaf_grade() {
        return leaf_grade;
    }

    public void setLeaf_grade(String leaf_grade) {
        this.leaf_grade = leaf_grade;
    }

    public String getBig_grade_code() {
        return big_grade_code;
    }

    public void setBig_grade_code(String big_grade_code) {
        this.big_grade_code = big_grade_code;
    }
    ...
    public String getProduction_flag() {
        return production_flag;
    }

    public void setProduction_flag(String production_flag) {
    ...
    public String getParch_flag() {
        return parch_flag;
    }

    public void setParch_flag(String parch_flag) {
        this.parch_flag = parch_flag;
    }
